...
SETTINGS_GROUPS: List[SettingGroup] = [
    SettingGroup(
        key="general",
        label="General",
        description="Global Phantom preferences.",
        options=[
            SettingOption(
                key="useSteamLanguage",
                label="Use Steam Language",
                option_type="toggle",
                description="Use the Steam client's language for Phantom.",
                default=True,
            ...
            SettingOption(
                ...
                label="Language",
                option_type="select",
                description="Choose the language used by Phantom.",
                default="en",
            ...
            SettingOption(
                ...
                label="Donate Keys",
                option_type="toggle",
                description="Allow Phantom to donate spare Steam keys. (placeholder option)",
                default=True,
                metadata={"yesLabel": "Yes", "noLabel": "No"},
            ),
            SettingOption(
                ...
                label="Theme",
                option_type="select",
                description="Choose the color theme for Phantom interface.",
                default="original",
